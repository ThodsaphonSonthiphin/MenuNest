...
Expected: `Pay-As-You-Go` / `personal@example.com`. Any other account is the **work** subscription — stop and re-login. Never create or modify anything in `AzureSubscriptionInALSO`.
